...
description: Use in this project before claiming a fix or completion state, to run fresh relevant verification commands and report evidence-backed status.
---
