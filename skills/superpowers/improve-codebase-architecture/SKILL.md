...
description: Find deepening opportunities and run architecture-level sanitation sweeps in this project, informed by domain language in docs/WorkingDocs/CONTEXT.md and decisions in docs/adr/ when present.
---
...
**Use `docs/WorkingDocs/CONTEXT.md` vocabulary for the domain, and [LANGUAGE.md](LANGUAGE.md) vocabulary for the architecture.** If the glossary defines "Software Project," use that domain term rather than a generic or imported-project label.
...
- **Naming a deepened module after a concept not in `docs/WorkingDocs/CONTEXT.md`?** Add the term to the glossary.
- **Sharpening a fuzzy term during the conversation?** Update `docs/WorkingDocs/CONTEXT.md` right there.
