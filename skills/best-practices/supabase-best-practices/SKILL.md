...
description: Use for project database work involving Supabase/Postgres queries, schema changes, indexing, RLS, company-scoped persistence, migrations, and performance tuning.
metadata:
  author: supabase
  version: "1.1.0"
