...
description: Use for React performance and refactor guidance in this project when improving component behavior, render performance, async data flow, bundle size, and UI responsiveness.
metadata:
  author: vercel
  version: "1.0.0"
---
...
- This project is a Vite SPA, not a Next.js App Router project. Next.js/RSC/server-action rules are reference material unless a future task introduces those surfaces.
...
| Priority | Category | Impact | Prefix | Project note |
|---|---|---|---|---|
