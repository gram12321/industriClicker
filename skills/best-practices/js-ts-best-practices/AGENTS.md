...
Read `SKILL.md` first. This directory is intentionally small: it provides language-level guidance for implementation work and delegates specialized guidance to sibling skills.
