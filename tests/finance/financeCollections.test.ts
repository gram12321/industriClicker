...
describe('loan collections', () => {
  it('escalates missed payments through warning, penalty, liquidation, and default', () => {
    ...
    expect(finance.applyTransaction({ amount: -200, description: 'Test withdrawal', detailLines: [], kind: 'equity', source: 'admin-adjustment', occurredAtGameTimeMs: 0 })).toBe(true);
