...
function getTransactionIcon(description: string): string {
  ...
  if (description.startsWith('Bought') || description.startsWith('Autobought')) return APP_ICONS.marketBuy;
  if (description.startsWith('Sold') || description.startsWith('Autosold')) return APP_ICONS.marketSell;
  if (description.startsWith('Constructed')) return APP_ICONS.building;
  if (description.startsWith('Contract fulfilled')) return APP_ICONS.contracts;
