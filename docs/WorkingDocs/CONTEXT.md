...
| Population consumption | One code-owned per-minute catalogue based on the existing Food, Raw Resources, Construction, Manufacturing, and Utilities domain totals. Each resource has a base amount and 0–1 preference, luxury, and price-elasticity values. |
