...
| Customer type | A buyer-behaviour profile separate from a home domain. Private Customer, Retail Chain, Construction Contractor, Industrial Enterprise, Utility Operator, and Government Procurement control frequency, target-value tendency, global premium tendency, bundle appetite, and allowed operating domains. |
| Customer relationship | A 0â€“100 company-specific score that decays toward a prestige-derived baseline during foreground time. Fulfilment gains scale with global-reference order value and taper as the relationship rises. Rejection and expiry both scale with relationship and order value; expiry is the larger loss. |
