...
| Sales contracts | Each foreground minute rolls a diminishing chance to create a random resource contract; valid fulfilment removes inventory, credits €1 per unit, and retains a completed record. | Implemented |
