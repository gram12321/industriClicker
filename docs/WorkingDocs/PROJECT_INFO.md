...
| Sales contracts | A random resource contract arrives every five foreground minutes; valid fulfilment removes inventory, credits €1 per unit, and retains a completed record. | Implemented |
