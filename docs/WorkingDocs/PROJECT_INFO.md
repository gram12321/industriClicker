...
- Implemented foundation: dashboard shell, local player/company selection, company-keyed local saves, standard-start onboarding, tutorial-guide placeholder, inventory, local/regional/global market, facilities, classified finance statements and rolling cash flow, local loans and credit ratings, sales contracts, foreground production with multi-output recipes, tiered company achievements, company prestige, local-first progression gates and grants, foreground research, IndustriPedia, and local saves.
