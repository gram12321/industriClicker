...
| Sales contracts | Each foreground minute rolls a diminishing chance to create a random resource contract; the Sales view separates Open and Closed contracts, with Completed/Rejected filtering inside Closed. | Implemented |
