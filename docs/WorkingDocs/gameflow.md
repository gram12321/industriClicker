...
- Wage-only Staff Quality pressure is reported as the current Q change per foreground minute after the quality curve: base wage is neutral, lower wages push toward Q1, and higher wages push toward Q100. Training and production experience are separate effects.
