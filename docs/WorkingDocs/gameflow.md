...
- Economy phase is persisted as crash, recession, stable, expansion, or boom. It starts stable and transitions deterministically every 10 foreground minutes: Stable has 15% chances to move toward recession or expansion; Recession/Expansion have a 35% chance to return to Stable, a 10% chance to move further from Stable, and otherwise stay; Crash/Boom have a 35% chance to return inward. It adjusts the interest rate on future offers. Credit rating derives from detailed asset health, payment history, company stability, and negative-balance penalty inputs.
