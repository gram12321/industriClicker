...
- Building the first facility grants free research for that facility's first recipe. It still takes its normal foreground research time and consumes the one-use grant when started.
