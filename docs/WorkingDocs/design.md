...
- Fertilizer is a shared agricultural input: the Chemical Plant synthesizes it from Chemicals and Minerals, and Farms consume it to grow Grain and Sugar. Animal-derived fertilizer and other residual outputs remain deferred until the game has a dedicated multi-output recipe model.
