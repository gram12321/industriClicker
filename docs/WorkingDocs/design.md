...
- The first content foundation uses the resources and facilities named in [CONTEXT.md](CONTEXT.md). Inventory and market reservoirs start at Q1. Quality affects a sale's price and mixes by quantity into inventory and market reservoirs. Every resource has an unlimited sequential quality-research chain; each completed level raises new facility output for that resource toward Q100.
