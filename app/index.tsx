...
function GameShell({ companyName }: { companyName: string }) {
  ...
  return (
    <SafeAreaView edges={['top']} style={styles.safeArea}>
      ...
      <InventoryTutorialDialog onBack={() => { const previousStage = tutorialStage ? getPreviousTutorialStage(tutorialStage) : null; if (previousStage) { setActiveView('production'); setTutorialStage(previousStage); } }} onDismiss={dismissTutorial} onExit={() => { void completeWelcomeTutorial(); }} onJumpToTutorial={jumpToTutorial} onNext={() => { void completeWelcomeTutorial(); }} tutorial={tutorialStagePresentation} visible={isInventoryTutorialOpen && activeView === 'inventory'} />
