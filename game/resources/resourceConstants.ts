...
export const RESOURCES: Readonly<Record<ResourceType, { name: string; icon: string; market: ResourceMarketDefinition }>> = {
  ...
  [ResourceType.Steel]: {
    name: 'Steel', icon: '🔩',
    market: { localBenchmarkSupply: 1_000, localInitialSupply: 200, regionalBenchmarkSupply: 10_000, regionalInitialSupply: 2_000, globalBenchmarkSupply: 100_000, globalInitialSupply: 20_000, logisticsMultiplier: 0.75, valueDensityMultiplier: 1.1 },
  },
  [ResourceType.ElectricCircuits]: {
    name: 'Electric Circuits', icon: '🔌',
    market: { localBenchmarkSupply: 600, localInitialSupply: 50, regionalBenchmarkSupply: 6_000, regionalInitialSupply: 500, globalBenchmarkSupply: 60_000, globalInitialSupply: 5_000, logisticsMultiplier: 1.25, valueDensityMultiplier: 1.35 },
  },
  [ResourceType.Bricks]: {
    name: 'Bricks', icon: '🧱',
  ...
  [ResourceType.ReinforcedConcrete]: {
    ...
    market: { localBenchmarkSupply: 1_500, localInitialSupply: 100, regionalBenchmarkSupply: 15_000, regionalInitialSupply: 1_000, globalBenchmarkSupply: 150_000, globalInitialSupply: 10_000, logisticsMultiplier: 0.4, valueDensityMultiplier: 1.15 },
  },
  [ResourceType.ConstructionMaterials]: {
    name: 'Construction Materials', icon: '🏗️',
    market: { localBenchmarkSupply: 1_250, localInitialSupply: 25, regionalBenchmarkSupply: 12_500, regionalInitialSupply: 250, globalBenchmarkSupply: 125_000, globalInitialSupply: 2_500, logisticsMultiplier: 0.5, valueDensityMultiplier: 1.2 },
  },
  [ResourceType.Sand]: {
    name: 'Sand', icon: '🏜️',
