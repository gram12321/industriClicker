...
export const RESEARCH_PROJECTS: readonly ResearchProjectDefinition[] = [
  ...
  { id: 'research-capacity-1', chainId: 'research-capacity', tier: 1, name: 'Research Capacity I', cost: 1_000, durationMs: 120_000, requirements: [FACILITY_TIER_1], effect: { kind: 'research-capacity', additionalSlots: 1 } },
  { id: 'research-capacity-2', chainId: 'research-capacity', tier: 2, name: 'Research Capacity II', cost: 4_000, durationMs: 300_000, requirements: [{ kind: 'research', projectId: 'research-capacity-1', label: 'Research Capacity I' }, CONTRACTS_TIER_1], effect: { kind: 'research-capacity', additionalSlots: 1 } },
  { id: 'research-capacity-3', chainId: 'research-capacity', tier: 3, name: 'Research Capacity III', cost: 12_000, durationMs: 900_000, requirements: [{ kind: 'research', projectId: 'research-capacity-2', label: 'Research Capacity II' }, CASH_TIER_1], effect: { kind: 'research-capacity', additionalSlots: 1 } },
  { id: 'research-capacity-4', chainId: 'research-capacity', tier: 4, name: 'Research Capacity IV', cost: 40_000, durationMs: 2_700_000, requirements: [{ kind: 'research', projectId: 'research-capacity-3', label: 'Research Capacity III' }, PRESTIGE_TIER_1], effect: { kind: 'research-capacity', additionalSlots: 1 } },
  { id: 'research-capacity-5', chainId: 'research-capacity', tier: 5, name: 'Research Capacity V', cost: 125_000, durationMs: 7_200_000, requirements: [{ kind: 'research', projectId: 'research-capacity-4', label: 'Research Capacity IV' }, CONTRACTS_TIER_2], effect: { kind: 'research-capacity', additionalSlots: 1 } },
  { id: 'research-capacity-6', chainId: 'research-capacity', tier: 6, name: 'Research Capacity VI', cost: 400_000, durationMs: 14_400_000, requirements: [{ kind: 'research', projectId: 'research-capacity-5', label: 'Research Capacity V' }], effect: { kind: 'research-capacity', additionalSlots: 1 } },
  { id: 'research-capacity-7', chainId: 'research-capacity', tier: 7, name: 'Research Capacity VII', cost: 1_200_000, durationMs: 28_800_000, requirements: [{ kind: 'research', projectId: 'research-capacity-6', label: 'Research Capacity VI' }], effect: { kind: 'research-capacity', additionalSlots: 1 } },
  { id: 'research-capacity-8', chainId: 'research-capacity', tier: 8, name: 'Research Capacity VIII', cost: 3_600_000, durationMs: 57_600_000, requirements: [{ kind: 'research', projectId: 'research-capacity-7', label: 'Research Capacity VII' }], effect: { kind: 'research-capacity', additionalSlots: 1 } },
  { id: 'research-capacity-9', chainId: 'research-capacity', tier: 9, name: 'Research Capacity IX', cost: 10_000_000, durationMs: 115_200_000, requirements: [{ kind: 'research', projectId: 'research-capacity-8', label: 'Research Capacity VIII' }], effect: { kind: 'research-capacity', additionalSlots: 1 } },
  { id: 'research-capacity-10', chainId: 'research-capacity', tier: 10, name: 'Research Capacity X', cost: 30_000_000, durationMs: 230_400_000, requirements: [{ kind: 'research', projectId: 'research-capacity-9', label: 'Research Capacity IX' }], effect: { kind: 'research-capacity', additionalSlots: 1 } },
