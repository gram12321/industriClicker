...
export const RESEARCH_PROJECTS: readonly ResearchProjectDefinition[] = [
  ...
  { id: 'sales-targeting-2', chainId: 'sales-targeting', tier: 2, name: 'Sales Targeting II', cost: 5000, durationMs: 300_000, requirements: [{ kind: 'research', projectId: 'sales-targeting-1', label: 'Sales Targeting I' }, ORDERS_TIER_1], effect: { kind: 'sales-offer-produced-resource-weight', multiplier: 4 } },
  ...
  { id: 'bid-value-2', chainId: 'bid-value', tier: 2, name: 'Bid Value II', cost: 4_000, durationMs: 300_000, requirements: [{ kind: 'research', projectId: 'bid-value-1', label: 'Bid Value I' }, ORDERS_TIER_1], effect: { kind: 'sales-order-bid-multiplier', multiplier: 1.3 } },
