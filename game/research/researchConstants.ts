...
export const RESEARCH_PROJECTS: readonly ResearchProjectDefinition[] = [
  ...
  { id: 'sales-capacity-2', chainId: 'sales-capacity', tier: 2, name: 'Sales Capacity II', cost: 1_000, durationMs: 60_000, requirements: [{ kind: 'research', projectId: 'sales-capacity-1', label: 'Sales Capacity I' }, CONTRACTS_TIER_1], effect: { kind: 'max-open-sales-orders', maximum: 5 } },
  ...
  { id: 'bid-value-1', chainId: 'bid-value', tier: 1, name: 'Bid Value I', cost: 1_000, durationMs: 120_000, requirements: [FACILITY_TIER_1], effect: { kind: 'sales-order-bid-multiplier', multiplier: 1.25 } },
  { id: 'bid-value-2', chainId: 'bid-value', tier: 2, name: 'Bid Value II', cost: 4_000, durationMs: 300_000, requirements: [{ kind: 'research', projectId: 'bid-value-1', label: 'Bid Value I' }, CONTRACTS_TIER_1], effect: { kind: 'sales-order-bid-multiplier', multiplier: 1.3 } },
  { id: 'bid-value-3', chainId: 'bid-value', tier: 3, name: 'Bid Value III', cost: 12_000, durationMs: 900_000, requirements: [{ kind: 'research', projectId: 'bid-value-2', label: 'Bid Value II' }, CASH_TIER_1], effect: { kind: 'sales-order-bid-multiplier', multiplier: 1.35 } },
  ...
  { id: 'bid-value-5', chainId: 'bid-value', tier: 5, name: 'Bid Value V', cost: 125_000, durationMs: 7_200_000, requirements: [{ kind: 'research', projectId: 'bid-value-4', label: 'Bid Value IV' }, CONTRACTS_TIER_2], effect: { kind: 'sales-order-bid-multiplier', multiplier: 1.5 } },
