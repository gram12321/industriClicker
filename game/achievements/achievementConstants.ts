...
export const ACHIEVEMENT_DEFINITIONS: readonly AchievementDefinition[] = [
  ...
  ...createTieredAchievements({ seriesId: 'fulfilled_contracts', category: 'sales', name: 'Order Closer', description: 'Fulfil {threshold} customer orders.', icon: 'handshake-outline', metric: 'fulfilled-contract-count', thresholds: [1, 10, 50] }),
