...
export const ALL_RECIPES: Readonly<Record<RecipeName, Recipe>> = {
  ...
  [RecipeName.GrowSugar]: {
    ...
    inputs: [
      ...
      { resourceType: ResourceType.Fertilizer, amount: 0.08 },
    ],
  ...
  [RecipeName.GrowFruit]: {
    ...
    inputs: [
      ...
      { resourceType: ResourceType.Fertilizer, amount: 0.06 },
    ],
  ...
  [RecipeName.SynthesizeFertilizer]: {
    ...
    inputs: [
      { resourceType: ResourceType.Chemicals, amount: 0.8 },
      { resourceType: ResourceType.Minerals, amount: 0.8 },
      { resourceType: ResourceType.Water, amount: 0.8 },
  ...
  [RecipeName.CoalPower]: {
    ...
    outputs: [{ resourceType: ResourceType.Electricity, amount: 14 }],
    requiredWork: 0.467,
    conditionWearMultiplier: 1.1,
  },
