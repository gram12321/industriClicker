...
export const ALL_RECIPES: Readonly<Record<RecipeName, Recipe>> = {
  ...
  [RecipeName.QuarryMinerals]: {
    ...
    output: { resourceType: ResourceType.Minerals, amount: 3 },
    requiredWork: 0.16,
    conditionWearMultiplier: 0.7,
  },
  [RecipeName.MineGold]: {
    ...
    output: { resourceType: ResourceType.Gold, amount: 0.2 },
    requiredWork: 0.667,
  ...
  [RecipeName.ProducePlastic]: {
    ...
    output: { resourceType: ResourceType.Plastic, amount: 4 },
    requiredWork: 1.667,
    conditionWearMultiplier: 1.2,
  },
  [RecipeName.ProduceSilicon]: {
    ...
    output: { resourceType: ResourceType.Silicon, amount: 2 },
    requiredWork: 2.017,
  ...
  [RecipeName.ProduceAdvancedComponents]: {
    ...
    output: { resourceType: ResourceType.AdvancedComponents, amount: 3 },
    requiredWork: 3.025,
  ...
  [RecipeName.AssembleIndustrialMachines]: {
    ...
    output: { resourceType: ResourceType.IndustrialMachines, amount: 4 },
    requiredWork: 5.95,
